    ...
    return (
        <>
            <div className="accordion-item">
                ...
                <div id={"flush-collapse" + props.number} className="accordion-collapse collapse" aria-labelledby={"flush-heading" + props.number} data-bs-parent={"#accordionFlushParent" + props.parentNumber}>
